...
Shiny is a decent method to demo your machine learning model or to Present your machine learning challenge so that others can upload test data and get amazed by your model. 

In this notebook, I have constructed a regularized logistic regression that predicts whether microchips from a fabrication plant passes quality assurance (QA). During QA, every microchip experiences different tests to guarantee it is working accurately.Suppose you are the item supervisor of the industrial facility  and you have the test results for some microchips on two different tests. From these two tests, you would like to determine whether the microchips should be accepted or rejected.

Next, we will save the model and build a shiny app and test the app by uploading test data. At last, we will download the data we uploaded with predictions using the machine learning model we built below. 

Source of Data : Machine Learning Coursera Course by Andrew Ng. 
Download Data  :  [here](http://datascience-enthusiast.com/data/ex2data2.txt).
